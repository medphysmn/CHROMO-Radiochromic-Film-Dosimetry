...
imageframeres = tk.Frame(doseresultsTk, width=imagedimres, height=imagedimres)
imageResizedres = pilimage.open("blank.jpg").resize((imagedimres,imagedimres))
imgres = itk.PhotoImage(imageResizedres)
labelImageres = tk.Label(imageframeres, image = imgres)
...
imageframeres.grid(column = 0, row = 0, padx=0, pady=0)
labelImageres.grid(column = 0, row = 0, padx=0, pady=0)
...
tk.Label(singleChannelTk, text="Choose fitting function (rational or exponential):", font=("Arial")).grid(column = 2, row = 0)
...
label_rational = tk.Label(propertiesTk, text="RATIONAL FUNCTION: f(x)= a + b/(x+c)", fg="blue", font=("Arial", 15), width=35).grid(column = 1, row = 1, pady=10)
...
label_exponential = tk.Label(propertiesTk, text="EXPONENTIAL FUNCTION: f(x)= a*exp(-x/b) + c", fg="blue", font=("Arial", 15), width=45).grid(column = 1, row = 11, pady=10)
...
label_exponential = tk.Label(propertiesTk, text="MULTICHANNEL CALIBRATION", fg="blue", font=("Arial", 15), width=45).grid(column = 1, row = 21, pady=10)
...
tk.Label(propertiesTk, text="Maximum recalibration dose:", font=("Arial")).grid(column = 4, row = 0, pady=10)
...
redchvalTk.grid(column = 4, row = 0)
...
greenchvalTk.grid(column = 4, row = 1)
...
bluechvalTk.grid(column = 4, row = 2)
...
calroidimvalTk.grid(column = 2, row = 2)

tk.Label(generalPropertiesTk, text="Roi dimension in pixel:", font=("Arial")).grid(column = 1, row = 3)
...
dimRoiCalibrationvalTk.grid(column = 2, row = 3)
...
isodoseDifferenceGyvalTk.grid(column = 2, row = 4)

tk.Label(generalPropertiesTk, text="Plot profiles of dose maps results:", font=("Arial")).grid(column = 1, row = 5)
plotprofilesval = tk.IntVar(generalPropertiesTk, value=0)
plotprofilesvalTk=tk.Entry(generalPropertiesTk, width=10, textvariable=plotprofilesval)
plotprofilesvalTk.grid(column = 2, row = 5)
...
doseRawImageOutputFormatvalTk.grid(column = 2, row = 6)

tk.Label(generalPropertiesTk, text="figures color map:", font=("Arial")).grid(column = 1, row = 7)
...
button_singleCalibrtion = tk.Button(singleChannelTk, text = "START CALIBRATION", command = lambda: singleChannelDosimetryGUI(rootFolder, 
                                                                                ...
                                                                                int(plotprofilesvalTk.get()),
                                                                                doseresultsTk, labelImageres)).grid(column = 1, row = 0 , padx=10, pady=10)
